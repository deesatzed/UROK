...
- Current AI/STT status is intentionally off: no model calls, no microphone access, no speech transcription.
...
| TQ-010: Add offline fun/early-stress tools | Done | Codex | Added Spark Joy prompts outside the critical SOS path. |
