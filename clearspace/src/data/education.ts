export const educationSections = [
  ...
  },
  {
    ...
    body: "If symptoms are new, severe, unusual, or feel medically concerning, contact emergency services or a trusted person. Get urgent help for chest pain, fainting, severe breathing trouble, stroke-like symptoms, self-harm thoughts, or any situation where you are unsure.",
  },
];
